...
const start = (port, dbPath, dist, logger) => {
  ...
  server.put(PUT_FUNCTIONS_PATH, (req, res) => registry.putFunctions(db, req, res, dist))

  server.post(`${API_BASE_PATH}/:functionName/invocations`, (req, res) => invoke.invoke20150331(lambda, db, req, res))
